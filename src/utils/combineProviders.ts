import { ComponentType, createElement, PropsWithChildren, ProviderProps, ReactElement } from 'react';
    ...
    return providers.reduceRight<ReactElement<ProviderProps<any>>>(
      (
        ...
        if (Array.isArray(currentProvider)) {
          ...
          return createElement(ProviderComponent, providerProps, childrenOfCurrentProvider);
        }
